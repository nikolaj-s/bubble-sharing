...
export const GitHubButton = () => {
    ...
    const download = () => {
        window.open('https://github.com/nikolaj-s/bubble-voice/releases', "_blank");
    }
